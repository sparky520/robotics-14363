                ...
                case stack1:
                    ...
                    if (!drive.isBusy() && pixelDropped){
                        ...
                        stack1 = drive.trajectorySequenceBuilder(boardPose)
                                ...
                                .waitSeconds(.2)
                                .splineToConstantHeading(new Vector2d(55 + pathXoffset,-22), Math.toRadians(280))
                                .addDisplacementMarker(() -> {
                                    robot.slide.setOuttakeSlidePosition(outtakeStates.etxending,outtakeStates.TOPSTACK);
                                })
                                .splineToConstantHeading(new Vector2d(53+ pathXoffset,25),Math.toRadians(280))
                                .build();
