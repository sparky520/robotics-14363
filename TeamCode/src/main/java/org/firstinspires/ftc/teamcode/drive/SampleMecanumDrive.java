...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap, boolean isRed) {
        ...
        setLocalizer(new TwoWheelTrackingLocalizer(hardwareMap, this, isRed));
