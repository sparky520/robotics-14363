...
@Autonomous(name = "long Red Park", group = "Auto")
    ...
    public void runOpMode() {
        ...
        if (blueDetection.getLocation().equals("RIGHT")){
            tape = drive.trajectorySequenceBuilder(start)
                    .lineToLinearHeading(new Pose2d(29,6, Math.toRadians(-90)))
                    .addDisplacementMarker(() -> {
                        robot.Claw.setTape();
                    })
                    .lineToConstantHeading(new Vector2d(29,-7))
                    .lineToConstantHeading(new Vector2d(29,5))
                    .lineToLinearHeading(new Pose2d(44,5,Math.toRadians(90)))
